...
export default function (state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case RABBITMQ_CONNECT_SUCCESS:
      return Object.assign({}, state, {isConnected: true, deviceInfo: action.payload.deviceInfo});
    case RABBITMQ_CONNECT_FAILED:
      return Object.assign({}, state, {isConnected: false,deviceInfo: action.payload.deviceInfo});
